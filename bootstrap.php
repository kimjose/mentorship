...
$envVars = ['SESSION_APP_NAME', 'SESSION_DURATION', 'PUBLIC_DIR', 'LOGS_DIR', 'DB_BACKUP_DIR', 'APP_NAME', 'DB_HOST', 'DB_DRIVER', 'DB_USER', 'DB_PASSWORD',
...
define("PRECONDITION_FAILED_RESPONSE_CODE", 412);
