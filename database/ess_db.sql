...
--
-- Dumping data for table `analytic_questions`
--

LOCK TABLES `analytic_questions` WRITE;
/*!40000 ALTER TABLE `analytic_questions` DISABLE KEYS */;
INSERT INTO `analytic_questions` VALUES (2,4,1),(3,1,1),(3,3,2),(4,8,1),(4,9,2),(4,35,3),(4,39,4);
/*!40000 ALTER TABLE `analytic_questions` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `analytic_run_lines`
--
...
CREATE TABLE `analytic_run_lines` (
  `id` int NOT NULL AUTO_INCREMENT,
  `analytic_run_id` int NOT NULL,
  `facility_id` int NOT NULL,
  `question_id` int NOT NULL,
  `answer` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `answer_value` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
--
-- Dumping data for table `analytic_run_lines`
--

LOCK TABLES `analytic_run_lines` WRITE;
/*!40000 ALTER TABLE `analytic_run_lines` DISABLE KEYS */;
INSERT INTO `analytic_run_lines` VALUES (42,23,2,8,'76','76','2023-02-02'),(43,23,2,8,'50','50','2023-02-28'),(44,23,2,8,'67','67','2023-03-20'),(45,23,2,8,'71','71','2023-04-21'),(46,23,2,9,'16783','16783','2023-02-28'),(47,23,2,9,'15908','15908','2023-03-20'),(48,23,2,9,'17102','17102','2023-04-21'),(49,23,2,35,'50','50','2023-02-28'),(50,23,2,35,'49','49','2023-03-20'),(51,23,2,35,'60','60','2023-04-21'),(52,23,2,39,'47','47','2023-02-28'),(53,23,2,39,'10','10','2023-03-20'),(54,23,2,39,'20','20','2023-04-21'),(68,26,2,8,'76','76','2023-02-02'),(69,26,2,8,'50','50','2023-02-28'),(70,26,2,8,'67','67','2023-03-20'),(71,26,2,8,'71','71','2023-04-21'),(72,26,2,9,'16783','16783','2023-02-28'),(73,26,2,9,'15908','15908','2023-03-20'),(74,26,2,9,'17102','17102','2023-04-21'),(75,26,2,35,'50','50','2023-02-28'),(76,26,2,35,'49','49','2023-03-20'),(77,26,2,35,'60','60','2023-04-21'),(78,26,2,39,'47','47','2023-02-28'),(79,26,2,39,'10','10','2023-03-20'),(80,26,2,39,'20','20','2023-04-21'),(81,27,2,8,'67','67','2023-03-20'),(82,27,2,8,'71','71','2023-04-21'),(83,27,2,9,'15908','15908','2023-03-20'),(84,27,2,9,'17102','17102','2023-04-21'),(85,27,2,35,'49','49','2023-03-20'),(86,27,2,35,'60','60','2023-04-21'),(87,27,2,39,'10','10','2023-03-20'),(88,27,2,39,'20','20','2023-04-21');
/*!40000 ALTER TABLE `analytic_run_lines` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `analytic_runs`
--
...
CREATE TABLE `analytic_runs` (
  ...
  `facility_ids` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `fk_analytic_run_creator` (`created_by`),
  KEY `fk_analytic_run_analytic` (`analytic_id`),
  CONSTRAINT `fk_analytic_run_analytic` FOREIGN KEY (`analytic_id`) REFERENCES `analytics` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fk_analytic_run_creator` FOREIGN KEY (`created_by`) REFERENCES `users` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=28 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `analytic_runs`
--

LOCK TABLES `analytic_runs` WRITE;
/*!40000 ALTER TABLE `analytic_runs` DISABLE KEYS */;
INSERT INTO `analytic_runs` VALUES (23,4,1,'2023-01-01','2023-04-24','2','2023-04-24 12:57:22','2023-04-24 12:57:22'),(26,4,1,'2023-02-01','2023-04-25','2','2023-04-25 08:49:56','2023-04-25 08:49:56'),(27,4,1,'2023-03-01','2023-04-25','2','2023-04-25 08:50:29','2023-04-25 08:50:29');
/*!40000 ALTER TABLE `analytic_runs` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `analytics` (
  ...
  `analytic_type` enum('Longitudinal','Across Sites') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `checklist_id` int NOT NULL,
  `qn_type` enum('check_opt','radio_opt','number_opt') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `created_by` int NOT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  ...
  CONSTRAINT `fk_analytics_checklist` FOREIGN KEY (`checklist_id`) REFERENCES `checklists` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fk_analytics_creator` FOREIGN KEY (`created_by`) REFERENCES `users` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE
...
INSERT INTO `analytics` VALUES (2,'Test','Test','Longitudinal',1,'radio_opt',1,'2023-04-20 11:56:04','2023-04-20 11:56:04'),(3,'Turbulence','Turb','Across Sites',1,'check_opt',1,'2023-04-20 11:58:39','2023-04-20 11:58:39'),(4,'C&T  Analytic','Analytic','Longitudinal',4,'number_opt',1,'2023-04-24 11:50:37','2023-04-24 11:50:37');
...
INSERT INTO `responses` VALUES (17,1,1,'cZfjg,Jnajz,GPZRB',1,'2023-02-23 11:29:35','2023-02-23 11:52:32'),(18,1,2,'Teller of doom',1,'2023-02-23 11:29:35','2023-02-23 11:52:32'),(19,1,4,'Jhvde',1,'2023-02-23 11:54:29','2023-02-23 11:54:29'),(33,1,8,'76',1,'2023-03-08 07:19:42','2023-03-08 07:19:42'),(34,1,11,'Bagger',1,'2023-03-08 07:19:42','2023-03-08 07:19:42'),(35,3,2,'What about now what about today',1,'2023-03-09 06:25:55','2023-03-09 06:25:55'),(36,3,4,'Jhvde',1,'2023-03-09 06:25:55','2023-03-09 06:25:55'),(37,5,1,'GPZRB',1,'2023-03-14 12:16:25','2023-03-14 12:16:25'),(38,5,2,'Doom tell',1,'2023-03-14 12:16:25','2023-03-14 12:16:25'),(39,5,4,'Jhryd',1,'2023-03-14 12:16:25','2023-03-14 12:16:25'),(40,3,3,'vkbRQ',1,'2023-03-15 09:45:54','2023-03-15 09:45:54'),(41,8,8,'50',1,'2023-04-24 11:43:29','2023-04-24 11:43:29'),(42,8,9,'16783',1,'2023-04-24 11:43:29','2023-04-24 11:43:29'),(43,8,10,'JCupA',1,'2023-04-24 11:43:29','2023-04-24 11:43:29'),(44,8,11,'Order',1,'2023-04-24 11:43:30','2023-04-24 11:43:30'),(45,8,12,'Blank',1,'2023-04-24 11:43:30','2023-04-24 11:43:30'),(46,8,13,'UiJQv',1,'2023-04-24 11:43:30','2023-04-24 11:43:30'),(47,8,32,'FxSik',1,'2023-04-24 11:43:30','2023-04-24 11:43:30'),(48,8,33,'Data Intern',1,'2023-04-24 11:43:30','2023-04-24 11:43:30'),(49,8,34,'uJfzC,qXMCj',1,'2023-04-24 11:43:30','2023-04-24 11:43:30'),(50,8,35,'50',1,'2023-04-24 11:43:30','2023-04-24 11:43:30'),(51,8,39,'47',1,'2023-04-24 11:43:30','2023-04-24 11:43:30'),(52,9,8,'67',1,'2023-04-24 11:46:26','2023-04-24 11:46:26'),(53,9,9,'15908',1,'2023-04-24 11:46:26','2023-04-24 11:46:26'),(54,9,10,'HbCnM',1,'2023-04-24 11:46:26','2023-04-24 11:46:26'),(55,9,11,'Banned',1,'2023-04-24 11:46:26','2023-04-24 11:46:26'),(56,9,12,'',1,'2023-04-24 11:46:26','2023-04-24 11:46:26'),(57,9,13,'xCbOL',1,'2023-04-24 11:46:26','2023-04-24 11:46:26'),(58,9,32,'FxSik',1,'2023-04-24 11:46:26','2023-04-24 11:46:26'),(59,9,33,'Data Officer',1,'2023-04-24 11:46:26','2023-04-24 11:46:26'),(60,9,34,'WpBFS,qXMCj',1,'2023-04-24 11:46:26','2023-04-24 11:46:26'),(61,9,35,'49',1,'2023-04-24 11:46:26','2023-04-24 11:46:26'),(62,9,39,'10',1,'2023-04-24 11:46:26','2023-04-24 11:46:26'),(63,10,8,'71',1,'2023-04-24 11:49:37','2023-04-24 11:49:37'),(64,10,9,'17102',1,'2023-04-24 11:49:37','2023-04-24 11:49:37'),(65,10,10,'KnSYQ',1,'2023-04-24 11:49:37','2023-04-24 11:49:37'),(66,10,11,'Piglets',1,'2023-04-24 11:49:37','2023-04-24 11:49:37'),(67,10,12,'Panned',1,'2023-04-24 11:49:37','2023-04-24 11:49:37'),(68,10,13,'xCbOL,pyzLt',1,'2023-04-24 11:49:37','2023-04-24 11:49:37'),(69,10,32,'FxSik',1,'2023-04-24 11:49:37','2023-04-24 11:49:37'),(70,10,33,'Data Officer',1,'2023-04-24 11:49:37','2023-04-24 11:49:37'),(71,10,34,'uJfzC,dPHEo',1,'2023-04-24 11:49:38','2023-04-24 11:49:38'),(72,10,35,'60',1,'2023-04-24 11:49:38','2023-04-24 11:49:38'),(73,10,39,'20',1,'2023-04-24 11:49:38','2023-04-24 11:49:38');
...
INSERT INTO `survey_set` VALUES (1,'Sample Survey','Sample Only',0,'2020-11-06','2020-12-10','2020-11-10 09:57:47'),(2,'Survey 1','Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec in tempus turpis, sed fermentum risus. Praesent vitae velit rutrum, dictum massa nec, pharetra felis. Phasellus enim augue, laoreet in accumsan dictum, mollis nec lectus. ',0,'2020-10-15','2020-12-30','2020-11-10 14:12:09'),(3,'Survey 2','Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec in tempus turpis, sed fermentum risus. Praesent vitae velit rutrum, dictum massa nec, pharetra felis. ',0,'2020-09-01','2020-11-27','2020-11-10 14:12:33'),(4,'Survey 23','Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec in tempus turpis, sed fermentum risus. Praesent vitae velit rutrum, dictum massa nec, pharetra felis. ',0,'2020-09-10','2020-11-27','2020-11-10 14:14:03'),(5,'Sample Survey 101','Sample only',0,'2020-10-01','2020-11-23','2020-11-10 14:14:29');
...
INSERT INTO `user_categories` VALUES (1,'Program','System Administrator','Test','1,2,3,4,5,6',1,'2023-03-31 07:56:52','2023-04-19 11:39:31'),(2,'Program','Program Administrator','This is the program admin','2,3,4,5',1,'2023-03-31 10:19:10','2023-03-31 10:19:10'),(3,'Facility','Facility Admin','Admin for facility','2,4,6',1,'2023-04-01 04:02:12','2023-04-05 06:34:59');
...
INSERT INTO `visit_findings` VALUES (1,5,'When you look at it\nlife can be a piece of shit\ni wish my self the best\nfor this stuff can be a beasts\n','15,16,17,18',1,'2023-04-05 07:24:31','2023-04-05 09:04:06'),(2,5,'Water source failure',NULL,1,'2023-04-05 10:15:35','2023-04-05 10:15:35'),(3,4,'The facility is with conflicts among staff','21',1,'2023-04-20 08:17:24','2023-04-20 08:18:48');
...
-- Dump completed on 2023-05-03  8:51:45
