				...
				<div class="row">
					<div class="col-md-6 border-right">
						...
						<div class="form-group">
							...
							<input type="text" name="first_name" class="form-control form-control-sm" required value="<?php echo isset($firstname) ? $firstname : '' ?>">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<input type="phone_number" name="contact" class="form-control form-control-sm" required value="<?php echo isset($contact) ? $contact : '' ?>">
						</div>
						<div class="form-group">
